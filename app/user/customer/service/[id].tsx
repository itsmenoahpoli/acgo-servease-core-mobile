				...
				<View className="-mt-8">
					<View className="bg-white rounded-t-3xl px-5 pt-6 pb-0 border border-gray-100">
						...
						<View className="flex-row items-center mb-3">
							...
							<Text className="text-sm text-gray-600 mx-2">{service.rating.toFixed(1)} Ratings</Text>
							<Text className="text-sm text-gray-400">• {service.reviews.toLocaleString()} Reviews</Text>
						</View>
						...
						<View className="flex-row items-center mb-4">
							...
							<Text className="text-sm text-gray-600 ml-2">{service.provider}</Text>
						</View>
						...
						<Text className="text-sm text-gray-700 leading-relaxed mb-6">{service.about}</Text>

						<View className="border-t border-gray-100 pt-6">
							<View className="flex-row items-center justify-between mb-4">
								<View>
									<Text className="text-xs text-gray-500">Starting at</Text>
									<Text className="text-xl font-bold text-gray-900">{service.price}</Text>
								</View>
								<View
