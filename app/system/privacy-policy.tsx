				...
				<ScrollView className="flex-1" contentContainerStyle={{ padding: 16 }}>
					<View className="mb-6">
						...
						<Text className="text-base text-gray-700 leading-6 mb-4">
							...
							create an account, make a purchase, request customer support, or otherwise
					...
					<View className="mb-6">
						...
						<Text className="text-base text-gray-700 leading-6 mb-2 ml-4">
							• To protect the rights, property, or safety of Servease Platform, our users, or
							others
						</Text>
						<Text className="text-base text-gray-700 leading-6 mb-4 ml-4">
