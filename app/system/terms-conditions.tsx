				...
				<ScrollView className="flex-1" contentContainerStyle={{ padding: 16 }}>
					<View className="mb-6">
						...
						<Text className="text-base text-gray-700 leading-6 mb-4">
							By accessing and using the Servease Platform, you accept and agree to be bound
					...
					<View className="mb-6">
						...
						<Text className="text-base text-gray-700 leading-6 mb-4">
							...
							Servease Platform for personal, non-commercial transitory viewing only. This is
					...
					<View className="mb-6">
						...
						<Text className="text-base text-gray-700 leading-6 mb-4">
							...
							under your account or password. You must notify us immediately of any
					...
					<View className="mb-6">
						...
						<Text className="text-base text-gray-700 leading-6 mb-4">
							...
							material we provide, in our sole discretion without notice. We will not be
							liable if, for any reason, all or any part of the service is unavailable at
					...
					<View className="mb-6">
						...
						<Text className="text-base text-gray-700 leading-6 mb-4">
							In no event shall Servease Platform, nor its directors, employees, partners,
